...
// Cross-source economic duplicate detection moved to `./dedup.ts` (#217): the old exact
// `economicFingerprint` was replaced by a tolerant pairwise matcher that absorbs the real
// CSV↔PDF divergences (action label, ±1 day settlement skew, decimal precision/locale).
